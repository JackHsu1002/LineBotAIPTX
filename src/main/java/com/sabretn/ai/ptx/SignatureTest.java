...
public class SignatureTest {
	...
	public static void main(String[] args) {
		...
		String APIUrl = "https://ptx.transportdata.tw/MOTC/v2/Bus/RealTimeByFrequency/City/Taipei?$top=1&$format=JSON";
	    //申請的APPID
        //（FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF 為 Guest 帳號，以IP作為API呼叫限制，請替換為註冊的APPID & APPKey）
        String APPID = "e05eecb090f4409dadea02e1b42a6b6f";
        //申請的APPKey
        String APPKey = "7cFtU44LyExxULzd0_di3a6Z8Yk";
